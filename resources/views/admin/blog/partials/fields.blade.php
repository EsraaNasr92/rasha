                                    ...
                                    <div class="dropdown-menu w-full">
                                        <ul class="dropdown-content">
                                            ...
                                            <li>
                                                <a href="javascript:;" class="dropdown-item">
                                                    <div class="w-6 h-6 absolute image-fit mr-3">
                                                        <img class="rounded" alt="Midone - HTML Admin Template" src="dist/images/profile-11.jpg">
                                                    </div>
                                                    <div class="ml-8 pl-1">Al Pacino</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:;" class="dropdown-item">
                                                    <div class="w-6 h-6 absolute image-fit mr-3">
                                                        <img class="rounded" alt="Midone - HTML Admin Template" src="dist/images/profile-13.jpg">
                                                    </div>
